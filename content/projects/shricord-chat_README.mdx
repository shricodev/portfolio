---
title: 'shricord-chat'
description: 'Minimalistic Discord with just the necessary features. 😻😎'
clone_url: 'https://github.com/shricodev/shricord-chat.git'
language: 'TypeScript'
homepage: 'https://shricord-chat-production.up.railway.app/'
topics:
  - 'chat-application'
  - 'discord-clone'
  - 'javascript'
  ...
  - 'showcase'
created_at: '2023-11-10T12:38:04Z'
updated_at: '2024-02-19T02:44:41Z'
---

![shricord chat](https://raw.githubusercontent.com/shricodev/shricord-chat/main/public/images/shricord-chat-2000-1500.png)
...
The `shricord-chat` project is a minimalistic Discord platform built using
Next.js, offering just the necessary features for a seamless user experience.
...
First of all, you need to have `pnpm`` installed on your machine. You can
...
> 🔴 **If you wish to setup the project locally, follow the installation
> instructions.**
...
See the [open issues](https://github.com/shricodev/shricord-chat/issues) for a
...
- If you have any suggestions, feel free to
  [open an issue](https://github.com/shricodev/shricord-chat/issues/new) to
  discuss it, or directly create a pull request.
...
[License](https://github.com/shricodev/shricord-chat/blob/main/LICENSE) for more
information.

## Authors

- **Shrijal Acharya** - _Full Stack SDE_ -
  [Shrijal Acharya](https://shricodev.tech) - _Founder_
