...
const QUERIES = {
  // Use searchPostsOfPublication to filter by author — avoids fetching all 12k+ FCC posts.
  // No pagination needed since there are only a handful of posts by this author.
  SEARCH_AUTHOR_POSTS: gql`
    query searchAuthorPosts(
      $first: Int!
